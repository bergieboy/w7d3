...
var requestAllPokemon = exports.requestAllPokemon = function requestAllPokemon() {
  return function (dispatch) {
    return APIUtils.fetchAllPokemon().then(function (pokemon) {
...
var selectAllPokemon = exports.selectAllPokemon = function selectAllPokemon(state) {
  return Object.keys(state.entities.pokemon).map(function (poke) {
    return state.entities.pokemon[poke];
  });
};
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    requestAllPokemon: dispatch((0, _pokemon_actions.requestAllPokemon)())
  };
};
